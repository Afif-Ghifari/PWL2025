        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ url('penjualan/' . $penjualan->penjualan_id. '/update') }}" class="form-horizontal"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select name="user_id" class="form-control">
                            @foreach ($user as $u)
                                <option value="{{ $u->user_id }}" @selected(old('user_id', $penjualan->user_id) == $u->user_id)>
                                    {{ $u->username }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="penjualan_kode" class="form-control" value="{{ old('penjualan_kode', $penjualan->penjualan_kode) }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="pembeli" class="form-control" value="{{ old('pembeli', $penjualan->pembeli) }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="date" name="penjualan_tanggal" class="form-control" value="{{ \Carbon\Carbon::parse($penjualan->penjualan_tanggal)->format('Y-m-d') }}">
                    </div>
                </div>
                    ...
                    <tbody id="detail-body">
                        @foreach ($penjualan->detail as $index => $detail)
                            <tr>
                                    ...
                                    <select name="barang_id[]" class="form-control select-barang">
                                        ...
                                        @foreach ($barang as $b)
                                            <option value="{{ $b->barang_id }}"
                                                ...
                                                @selected($b->barang_id == $detail->barang_id)>
                                                {{ $b->barang_nama }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <td>
                                    <input type="text" name="harga_jual[]" class="form-control harga-jual" value="{{ $detail->harga / $detail->jumlah }}" readonly>
                                </td>
                                <td>
                                    <input type="number" name="jumlah[]" class="form-control jumlah" min="1" value="{{ $detail->jumlah }}">
                                </td>
                                <td>
                                    <input type="text" class="form-control subtotal" value="{{ $detail->harga }}" readonly>
                                </td>
                                <td>
